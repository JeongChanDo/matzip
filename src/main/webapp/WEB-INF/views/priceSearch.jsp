...
<div id="contain">
	...
	<div id="nav">
		<div><a href="areaSearch.jsp">맛집검색</a></div>
		<div><a href="recommend.jsp">맛집추천</a></div>
		<div><a href="epilogue.jsp">맛집후기</a></div>
		<div><a href="customerCenter.jsp">고객센터</a></div>
	</div>
	...
	<div id="sidebar">
		...
		<div class="seaTabs">
			<div class="seaTabs_switch">
				...
				<div class="seaTabs_tab seaTabs_switch_active" >가격별</div>
			</div>
			<div class="seaTabs_content">				
				...
				<input type="radio" name="area" value="지역" >한식<br/><br/>
				...
				<input type="radio" name="area" value="지역" checked>5천원미만<br/><br/>
