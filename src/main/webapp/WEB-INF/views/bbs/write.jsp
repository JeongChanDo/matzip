...
<div id="bbsWriteDiv">
	...
	<form method="post" action="articleWriteProcess" enctype="multipart/form-data" >
		<input type="hidden" id="photoCheckResult" name="photoExist" value="no"/>
       	<input type="hidden" name="boardNo" value="<%=boardNo %>"/>
       	<div class="input-group input-group-lg">
       	<input id="inputTitle" class="form-control" type="text" name="title" maxlength="50" placeholder="제목"/>
       	</div>
           <br/><br/>
